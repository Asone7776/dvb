            ...
            <div className="row h-100">
                <div className="col-12">
                    <div className="top-heading">
                        ...
                        <p>
                            Комплексное страхование имущества юридических лиц и индивидуальных предпринимателей. Комплексная защита имущества и гражданской ответственности для малого и среднего бизнеса (предприятий торговли, сферы обслуживания, организаций по предоставлению административных услуг)
                        </p>
                    </div>
                </div>
